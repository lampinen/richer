...
descriptor_output_size =(3)+ (4) + (2) #(actual items in this row/column/diagonal) + (interesting state in this location: 3 in row for me, unblocked 2 in row for me, "" for him) + (fork for me, fork for him)  TODO: include other useful feature descriptors
